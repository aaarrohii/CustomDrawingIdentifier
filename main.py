...
class DrawingClassifier:
    ...
    def classes_prompt(self):
        ...
        if os.path.exists(self.proj_name):
            ...
            self.class1 = simpledialog.askstring("Class 1", "What is your first custom drawing called?", parent=msg)
            self.class2 = simpledialog.askstring("Class 2", "What is your second custom drawing called?", parent=msg)
            self.class3 = simpledialog.askstring("Class 3", "What is your third custom drawing called?", parent=msg)
    ...
    def init_gui(self):
        ...
        self.root = Tk()
        self.root.title(f"Aarohi Custom Drawing Classifier! - {self.proj_name}")
    ...
    def train_model(self):
        ...
        tkinter.messagebox.showinfo("Aarohi Custom Drawing Classifier!", "Model successfully trained!", parent=self.root)
    ...
    def predict(self):
        ...
        if prediction[0] == 1:
            tkinter.messagebox.showinfo("Aarohi Custom Drawing Classifier!", f"The drawing is probably a {self.class1}", parent=self.root)
        elif prediction[0] == 2:
            tkinter.messagebox.showinfo("Aarohi Custom Drawing Classifier!", f"The drawing is probably a {self.class2}", parent=self.root)
        elif prediction[0] == 3:
            tkinter.messagebox.showinfo("Aarohi Custom Drawing Classifier!", f"The drawing is probably a {self.class3}", parent=self.root)
    ...
    def save_model(self):
        ...
        tkinter.messagebox.showinfo("Aarohi Custom Drawing Classifier!", "Model successfully saved!", parent=self.root)

    def load_model(self):
        file_path = filedialog.askopenfilename()
        with open(file_path, "rb") as f:
            self.clf = pickle.load(f)
        tkinter.messagebox.showinfo("Aarohi Custom Drawing Classifier!", "Model successfully loaded!", parent=self.root)
    ...
    def save_everything(self):
        ...
        with open(f"{self.proj_name}/{self.proj_name}_data.pickle", "wb") as f:
            pickle.dump(data, f)
        tkinter.messagebox.showinfo("Aarohi Custom Drawing Classifier!", "Project successfully saved!", parent=self.root)
